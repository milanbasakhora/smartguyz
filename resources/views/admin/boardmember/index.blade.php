                ...
                <table class="table table-striped" id="table-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border border-1">
                                <a href="{{ route('boardmember.edit', $boardmember->id) }}" class="btn btn-primary btn-sm text-white"> <i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="{{ route('boardmember.destroy', $boardmember->id) }}" class="btn btn-danger btn-sm text-white" data-confirm-delete="true"> <i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
